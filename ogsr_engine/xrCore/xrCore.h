...
public:
    ...
    struct Feature
    {
        static constexpr u64 
            ...
            artefacts_from_all          = 1ull << 5,
            stop_anim_playing           = 1ull << 6,
            ...
            old_outfit_slot_style       = 1ull << 16,
            npc_simplified_shooting     = 1ull << 17,
            use_trade_deficit_factor    = 1ull << 18,
            show_objectives_ondemand    = 1ull << 19,
