...
public:
    ...
    struct Feature
    {
        static constexpr u64 
            ...
            artefacts_from_all          = 1ull << 6,
            stop_anim_playing           = 1ull << 7,
            corpses_collision           = 1ull << 8,
            keep_inprogress_tasks_only  = 1ull << 9,
            gd_master_only              = 1ull << 10,
            scope_textures_autoresize   = 1ull << 11,
