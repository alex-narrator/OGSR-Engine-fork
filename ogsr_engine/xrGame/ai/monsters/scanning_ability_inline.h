...
void CScanningAbilityAbstract::load(LPCSTR section)
{
    ...
    sscanf(pSettings->r_string(ppi_section, "color_base"), "%g,%g,%g", &m_effector_info.color_base.r, &m_effector_info.color_base.g, &m_effector_info.color_base.b);
    sscanf(pSettings->r_string(ppi_section, "color_gray"), "%g,%g,%g", &m_effector_info.color_gray.r, &m_effector_info.color_gray.g, &m_effector_info.color_gray.b);
    sscanf(pSettings->r_string(ppi_section, "color_add"), "%g,%g,%g", &m_effector_info.color_add.r, &m_effector_info.color_add.g, &m_effector_info.color_add.b);
