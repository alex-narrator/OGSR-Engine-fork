...
constexpr auto ARIAL14_FONT_NAME = "arial_14";
constexpr auto ARIAL21_FONT_NAME = "arial_21";

constexpr auto MEDIUM_FONT_NAME = "medium";
constexpr auto SMALL_FONT_NAME = "small";

constexpr auto GRAFFITI19_FONT_NAME = "graffiti19";
constexpr auto GRAFFITI22_FONT_NAME = "graffiti22";
constexpr auto GRAFFITI32_FONT_NAME = "graffiti32";
constexpr auto GRAFFITI40_FONT_NAME = "graffiti40";
constexpr auto GRAFFITI50_FONT_NAME = "graffiti50";

constexpr auto LETTERICA16_FONT_NAME = "letterica16";
constexpr auto LETTERICA18_FONT_NAME = "letterica18";
constexpr auto LETTERICA25_FONT_NAME = "letterica25";

constexpr auto DI_FONT_NAME = "di";
...
void CUIXmlInit::InitColorDefs()
{
    ...
    R_ASSERT3(flag, "xml file not found: color_defs.xml", COLOR_DEFINITIONS);
