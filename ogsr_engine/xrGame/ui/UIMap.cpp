...
Fvector2 CUICustomMap::ConvertRealToLocalNoTransform(const Fvector2& src, Frect const& bound_rect) const // meters->pixels (relatively own left-top pos)
{
    Fvector2 res;
...
Fvector2 CUICustomMap::ConvertRealToLocalNoTransform(const Fvector2& src) const // meters->pixels (relatively own left-top pos)
{
    Fvector2 res;
