...
void CBolt::Load(LPCSTR section) {
    ...
    if (m_bQuickThrow)
    {
        m_sounds.LoadSound(section, "snd_quick_throw_start", "sndQuickThrowStart", SOUND_TYPE_WEAPON_EMPTY_CLICKING);
        m_sounds.LoadSound(section, "snd_quick_throw", "sndQuickThrow", SOUND_TYPE_WEAPON_SHOOTING);
        m_sounds.LoadSound(section, "snd_quick_throw_end", "sndQuickThrowEnd", SOUND_TYPE_WEAPON_EMPTY_CLICKING);
