...
void iterate_nearest(const Fvector& pos, float radius, luabind::functor<bool> functor)
{
    ...
    for (const auto obj : m_nearest)
        if (auto GO = smart_cast<CGameObject*>(obj))
...
void CLevel::script_register(lua_State* L)
{
    module(L)[class_<CEnvDescriptor>("CEnvDescriptor")
        ...
        module(L, "actor_stats")[def("add_points", &add_actor_points), def("add_points_str", &add_actor_points_str), def("get_points", &get_actor_points),
                                 def("get_points_key", &get_actor_points_key),
    ...
    module(L)[
        ...
        def("set_pnv_params_2", [](const float& p1, const float& p2, const float& p3, const float& p4) { shader_exports.set_pnv_params_2(p1, p2, p3, p4); }), //tube num|work area radius
        ...
        def("set_markswitch_params", [](const float& p1, const float& p2, const float& p3, const float& p4) { shader_exports.set_markswitch_params(p1, p2, p3, p4); }),
        ...
        // weapon params
        def("set_weapon_params", [](const float& p1, const float& p2, const float& p3, const float& p4) { shader_exports.set_weapon_params(p1, p2, p3, p4); }),
