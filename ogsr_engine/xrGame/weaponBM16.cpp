...
void CWeaponBM16::PlayAnimIdleMovingCrouchSlow()
{
    ...
    case 1:
        PlayHUDMotion({"anm_idle_moving_crouch_slow_1", "anm_idle_moving_crouch_1", "anim_idle_moving_1", "anim_idle_moving", "anim_idle_1", "anm_idle_moving_1"}, true,
                      GetState());
        break;
    case 2:
        PlayHUDMotion({"anm_idle_moving_crouch_slow_2", "anm_idle_moving_crouch_2", "anim_idle_moving_2", "anim_idle_moving", "anim_idle_2", "anm_idle_moving_2"}, true,
                      GetState());
        break;
    }
}
...
void CWeaponBM16::PlayAnimOnItemTake()
{
    ...
    {
    case 0:
        AnimationExist("anm_on_item_take_0") ? PlayHUDMotion("anm_on_item_take_0", true, GetState()) : PlayHUDMotion({"anim_draw_0", "anim_draw", "anm_show_0"}, true, GetState());
        break;
    case 1:
        AnimationExist("anm_on_item_take_1") ? PlayHUDMotion("anm_on_item_take_1", true, GetState()) : PlayHUDMotion({"anim_draw_1", "anim_draw", "anm_show_1"}, true, GetState());
        break;
    case 2:
        AnimationExist("anm_on_item_take_2") ? PlayHUDMotion("anm_on_item_take_2", true, GetState()) : PlayHUDMotion({"anim_draw_2", "anim_draw", "anm_show_2"}, true, GetState());
        break;
    }
...
void CWeaponBM16::PlayAnimCheckout()
{
    switch (m_magazine.size())
    {
    case 0: AnimationExist("anm_checkout_0") ? PlayHUDMotion("anm_checkout_0", true, GetState()) : PlayHUDMotion({"anim_idle_0", "anm_bore_0"}, true, GetState()); break;
...
void CWeaponBM16::PlayAnimCheckGear()
{
    ...
    {
    case 0:
        AnimationExist("anm_check_gear_0") ? PlayHUDMotion("anm_check_gear_0", true, GetState()) : PlayHUDMotion({"anim_draw_0", "anim_draw", "anm_show_0"}, true, GetState());
        break;
    case 1:
        AnimationExist("anm_check_gear_1") ? PlayHUDMotion("anm_check_gear_1", true, GetState()) : PlayHUDMotion({"anim_draw_1", "anim_draw", "anm_show_1"}, true, GetState());
        break;
    case 2:
        AnimationExist("anm_check_gear_2") ? PlayHUDMotion("anm_check_gear_2", true, GetState()) : PlayHUDMotion({"anim_draw_2", "anim_draw", "anm_show_2"}, true, GetState());
        break;
    }
