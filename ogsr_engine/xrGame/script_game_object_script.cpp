           ...
           class_<enum_exporter<GameObject::ECallbackType>>("callback")
               .enum_("callback_types")
                   [(value("trader_global_anim_request", int(GameObject::eTraderGlobalAnimationRequest)),
                    ...
                    value("map_location_focus", int(GameObject::eMapLocationFocus)), value("map_location_focus_lost", int(GameObject::eMapLocationFocusLost)),
                    ...
                    value("on_hud_item_zoom_in", int(GameObject::eOnHudItemZoomIn)), value("on_hud_item_zoom_out", int(GameObject::eOnHudItemZoomOut)),
                    ...
                    value("on_actor_weapon_fire_mode_change", int(GameObject::eOnActorWeaponFireModeChange)),
                    ...
                    value("on_hud_state_switch", int(GameObject::eOnHudStateSwitch)), value("on_motion_mark", int(GameObject::eOnMotionMark)),
