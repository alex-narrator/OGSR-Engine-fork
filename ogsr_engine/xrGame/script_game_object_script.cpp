           ...
           class_<enum_exporter<GameObject::ECallbackType>>("callback")
               .enum_("callback_types")
                   [value("trade_start", int(GameObject::eTradeStart)), value("trade_stop", int(GameObject::eTradeStop)),
                    ...
                    value("on_ruck", int(GameObject::eOnItemToRuck)), value("on_slot", int(GameObject::eOnItemToSlot)),
                    value("on_belt", int(GameObject::eOnItemToBelt)), value("on_vest", int(GameObject::eOnItemToVest)),
                    ...
                    value("on_inv_box_open", int(GameObject::eOnInvBoxOpen)), value("select_pda_contact", int(GameObject::eSelectPdaContact)),

                    value("on_booster_enable", int(GameObject::eBoosterEnable)), value("on_booster_disable", int(GameObject::eBoosterDisable)),
